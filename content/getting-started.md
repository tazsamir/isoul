...
- **Notes and documents** → [Simplenote](https://simplenote.com/) *(the service I use)*; [Joplin](https://joplinapp.org/) is another open-source alternative, but not one I currently use.
